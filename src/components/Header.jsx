...
import { logo_purple } from "../assets";
  ...
  return (
    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        <a href="#hero" className="flex items-center gap-2 w-[12rem] xl:mr-8">
          <img src={logo_purple} width={40} height={40} alt="Brainwave" />
          <span className="text-n-1 h5">ProSynth</span>
        </a>
        <nav
          className={`${
            openNav ? "flex" : "hidden"
